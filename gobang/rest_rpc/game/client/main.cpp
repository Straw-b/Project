...
void Usage()
{
    cout << "./client [svr_ip] [svr_port]" << endl;
}
...
void Menu()
{
    ...
    cout << "** 3.登出           4.退出 **" << endl;
    cout << "*****************************" << endl;
    cout << "please enter your chooies: " << endl;
}
...
int main(int argc, char* argv[]) 
{
    ...
    while(1)
    {
        ...
        switch(select)
        {
            ...
            case 2:
                {
                    ...
                    if(id < 1000)
                    {
                        cout << "Login failed!, please check ID or passwd!  login again!" << endl;
                    }
                    else
                    {
                        //接下来就可以进行匹配， 然后下棋了
                        cout << "Login success!, please game..." << endl;
                        client.Game();
                    }
                }
                break;
            ...
            //输入的不对
            default:
                cout << "input num fault, please chooies again!" << endl;
                break;
        }
    }
    return 0;
